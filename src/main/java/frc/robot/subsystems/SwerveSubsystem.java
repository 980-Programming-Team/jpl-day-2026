...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  {
    swerveDrive = new SwerveDrive(driveCfg, controllerCfg, Constants.MAX_SPEED, null);
  }
  ...
  {
    swerveDrive.setMaximumAllowableSpeeds(maximumSpeedInMetersPerSecond, maximumSpeedInMetersPerSecond);
  }
